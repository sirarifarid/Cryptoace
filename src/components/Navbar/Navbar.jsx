        ...
        <div className="relative flex items-center justify-between">
          ...
          <ul className="hidden mf:flex items-center space-x-8">
            <li>
              <>
                <button type="button">
                  <a class="group relative inline-flex items-center justify-center overflow-hidden rounded-full p-2 px-5 py-1 font-medium text-btnText shadow-xl transition duration-300 ease-out">
                    ...
                    <span class="relative text-white text-lg">
                      Connect Wallet
                    </span>
                  </a>
                </button>
